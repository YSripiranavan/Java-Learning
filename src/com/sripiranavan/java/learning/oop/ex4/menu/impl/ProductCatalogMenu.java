...
import com.sripiranavan.java.learning.oop.ex4.services.ProductManagementService;
import com.sripiranavan.java.learning.oop.ex4.services.impl.DefaultProductManagementService;
	...
	public void start() {
		...
		while (true) {
			...
			if (userInput.equalsIgnoreCase(CHECKOUT_COMMAND)) {
				...
				proccessAddToCart(productToAddToCart);
			}
		}
		menuToNavigate.start();
	}

	private void proccessAddToCart(Product productToAddToCart) {
