...
//						+ remove10000000ElementLinkedListMiddle);
	...
	private static void removeElementsFromEnd(List<Integer> list, int numberOfElementsToRemove) {
		for (int i = 0; i < numberOfElementsToRemove; i++) {
			list.remove(list.size() - 1);
		}
	}

	private static void removeElementsFromMiddle(List<Integer> list, int numberOfElementsToRemove) {
		for (int i = 0; i < numberOfElementsToRemove; i++) {
			list.remove(list.size() / 2);
		}
	}

	private static void removeElementsFromBeginning(List<Integer> list, int numberOfElementToRemove) {
		for (int i = 0; i < numberOfElementToRemove; i++) {
			list.remove(0);
		}
	}

	private static void addElementsToEnd(List<Integer> list, int numberOfElementToAdd) {
		for (int i = 0; i < numberOfElementToAdd; i++) {
			list.add(Integer.MAX_VALUE);
		}
	}

	private static void addElementsToMiddle(List<Integer> list, int numberOfElementsToAdd) {
		for (int i = 0; i < numberOfElementsToAdd; i++) {
			list.add(list.size() / 2, Integer.MAX_VALUE);
		}
	}

	private static void addElementsToBeginning(List<Integer> list, int numberOfElementsToAdd) {
		for (int i = 0; i < numberOfElementsToAdd; i++) {
